...
## 1.5
* Updated to support MCreator 2025.3
* Added support for NeoForge 1.21.1, 1.21.8 and Fabric 1.21.8
* Removed support for all previous versions
* The Chunk Manager category is now located inside the World procedures category
